...
SPACE_NETWORK_TUPLEPATH = {
    ...
    ("p_liq_to_out_pairs", 0, "EE"): [0.05, 0.10, 0.20],
    ("p_liq_to_out_pairs", 0, "EI"): [0.05, 0.10, 0.20],
    ("p_liq_to_out_pairs", 0, "IE"): [0.05, 0.10, 0.20],
    ("p_liq_to_out_pairs", 0, "II"): [0.05, 0.10, 0.20],

    ("gain_liq_to_out_pairs", 0, "EE"): [0.5, 1.0, 2.0],
    ("gain_liq_to_out_pairs", 0, "EI"): [0.5, 1.0, 2.0],
    ("gain_liq_to_out_pairs", 0, "IE"): [0.5, 1.0, 2.0],
    ("gain_liq_to_out_pairs", 0, "II"): [0.5, 1.0, 2.0],
}
